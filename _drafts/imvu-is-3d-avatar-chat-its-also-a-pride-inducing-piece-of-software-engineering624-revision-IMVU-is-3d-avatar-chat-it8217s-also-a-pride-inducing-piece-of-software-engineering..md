...
date: 2009-02-14T09:33:58+00:00
author: mcgrue
layout: revision
guid: http://www.egometry.com/gruedorf/624-revision/
permalink: /gruedorf/624-revision/
---
### Twitter conversing
...
<div style="padding: 20px; background-color: silver;">
  ...
  <p>
    ...
    <p>
      What Jeff Atwood is missing the complete point of is that the deployment system <em>is</em> sweet, and a successful &#8220;3d chat game&#8221; requires some amazing pieces of engineering required to pull it off. We have a 3d desktop application, a chat service, a giant catalog, a very high-traffic site, and an always-increasing number of persistent users.
    </p>
